    ...
    return (
        <div ref={containerRef} className="relative w-full select-none">
            {tooltip && (
                <div
                    role="tooltip"
                    className="pointer-events-none absolute z-10 min-w-35 rounded-md border bg-popover px-3 py-2 text-xs text-popover-foreground shadow-md"
                ...
                >
                    ...
                    <p>
                        Scans: <span className="font-medium tabular-nums">{tooltip.point.scans}</span>
                    </p>
                    <p>
                        Violations: <span className="font-medium tabular-nums">{tooltip.point.violations}</span>
                    </p>
                </div>
            )}
            <svg
