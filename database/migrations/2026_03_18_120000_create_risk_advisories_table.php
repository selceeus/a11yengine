...
return new class extends Migration
{
    ...
    {
        Schema::create('risk_advisories', function (Blueprint $table): void {
            $table->id();
            ...
            $table->unsignedInteger('total_recommendations')->nullable();
            $table->unsignedInteger('issues_analyzed')->nullable();
    ...
    {
        Schema::dropIfExists('risk_advisories');
    }
};
